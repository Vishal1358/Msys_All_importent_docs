...
btn_numbers = []
for i in range(10):
    btn_numbers.append(Button(width=4, text=str(i), font="time 15 bold", bd=5,
...
btn_equal = btn_clear = Button(width=4, text='=', font="times 15 bold", bd=5, command=funcOperator)
